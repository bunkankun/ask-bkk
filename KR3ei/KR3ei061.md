...
The work has come down with two important appendices: (i) a *Shēngshēng wàilù* 生生外錄 ("Outer Record of Life-Engendering") supplied by the editor Hú Xuěqīng 高雪清 with neonatal-care and external-medicine prescriptions (mostly drawn from the editor's own family practice and from Tàizǔshī Lǐ 李 of Tàizǔshī temple); (ii) a *Bǎochì biān* 保赤編 on neonatal *qífēng* tetanus, treating from the same compilatory base as the [[KR3ei055]] *Dáshēng biān* appendix. Húshì of Shāncūn 山村 signs the postface in *Dàoguāng* 5 (1825) — establishing the latest possible date for completion of the work as we have it.
...
3. **Inclusion of an external-medicine appendix** treating *dīngdú* 疔毒, *yōngjū* 癰疽, *rǔyán* 乳岩 (breast cancer / abscess), and pregnancy-period boils — unusual for an obstetrical work and reflecting the editorial extension by Húshì and Gāo Xuěqīng 高雪清.
