...
The local repository preserves only a header file. The standard preface (in major Míng editions) is dated to the LóngqìngWànlì era (mid-16th c.) and is signed under the *Xuē* publishing imprint.
