...
The local repository file is an empty placeholder. The work survives in the *Zoku gunsho ruijū* 続群書類従 collection and as Daigo-ji manuscript copies. The standard transmitted text includes a preface attributed to Shōzon 性尊 dated to the Hōgen 保元 era (1156–1159), which is the date that the catalog meta's "日本·保元" dynasty field encodes.
