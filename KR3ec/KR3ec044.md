...
The work in 4 *juǎn* gives the *Běnjīng* text for each substance and then provides exegetical commentary on its qì-wèi, *guī-jīng*, and main effects. The exegesis is theoretically clear and pedagogically accessible, which explains the work's success.
