...
(1) On *Nán shān*'s *bì gào fùmǔ* ("must report to father and mother"): Jì Běn reads this as Lǔ Huán (Wén-jiāng's husband) reporting to the *fùmǔ zhī miào* (parents' temple), not to living parents — supplying the Spring-and-Autumn ritual context.
...
(4) On *Huáng-fù qīngshì*'s naming of multiple ministers: Jì Běn argues that the order is by favour, not rank — so high and low can mix in the same list.
