...
The *Liùwèi dìhuáng wán* — Qián Yǐ's paediatric modification of the Sòng *Shènqì wán* by removing *fùzǐ* and *guìzhī* — is the most clinically consequential prescription in the history of Chinese medicine, in the literal sense that it founded the entire post-Sòng *zīyīn* 滋陰 (yin-nourishing) therapeutic tradition. Zhū Dānxī's *yáng cháng yǒu yú, yīn cháng bùzú* 陽常有餘陰常不足 doctrine and the MíngQīng *wēnbìng* (warm-disease) school both descend from Qián Yǐ's prescription move. The work's case-history *juǎn* 2 is one of the earliest extended *yīàn* (medical case) corpora in Chinese medicine and is a principal primary source for the social history of Northern-Sòng paediatric practice.
