...
The text is sourced from the **CHANT** (Chinese Ancient Text) **database**, a major electronic-text project based at the Chinese University of Hong Kong. CHANT V44 is the *Lièzǐ* volume of this series. The Kanseki edition uses the Kanseki **TLS** (Thesaurus Linguae Sericae) base-edition — Christoph Harbsmeier's critical-linguistic reconstruction — which matches the pattern used for the *Lǎozǐ* at [[KR5c0057]].
