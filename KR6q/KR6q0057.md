...
textid: KR6q0057
title: 楊岐方會和尚後錄
pinyinTitle: Yángqí Fānghuì héshàng hòulù
extent: 1 卷
notBefore: 1050
notAfter: 1100
dynasty: 宋
...
supplementary recorded sayings of [[方會]] Yángqí Fānghuì (992–1049); compiler not named in the transmitted text
...
Dating follows the window for the main *yǔlù* ([[KR6q0056]]): *terminus post quem* 1050 (when Wénzhèng's preface attests the first compilation); *terminus ante quem* 1100 is a conservative upper bracket, since the Yángqí line's recorded-sayings corpus was well consolidated by the time Yuánwù Kèqín 圓悟克勤 (1063–1135) was drawing on it in the late eleventh and early twelfth centuries. The absence of a named compiler for the *hòulù* suggests it may have been assembled by the same or an adjacent editorial hand to Rényǒng's main *yǔlù*.
