...
textid: KR6q0053
title: 鎮州臨濟慧照禪師語錄
pinyinTitle: Zhènzhōu Línjì Huìzhào chánshī yǔlù
extent: 1 卷
notBefore: 1120
notAfter: 1120
dynasty: 宋
...
The *Línjì lù* 臨濟錄 — one of the most influential recorded-sayings (*yǔlù* 語錄) collections in the Chán tradition, and the single most consequential document of the Línjì school founded by [[義玄]] Línjì Yìxuán (d. 866). The received one-juan text comprises the "Upper Hall Discourses" (*shàngtáng* 上堂), "Presented to the Assembly" (*shìzhòng* 示眾), "Examining Instruction" (*kānbiàn* 勘辨) — the question-and-answer encounter section — and a brief "Pilgrimage Record" (*xíngyóu* 行由) with a funerary *xíngzhuàng* 行狀 appendix. It is the *locus classicus* for the defining apparatus of the Línjì school: the *sān-xuán sān-yào* 三玄三要 ("three mysteries and three essentials"), *sì-liào-jiǎn* 四料簡 ("four procedures of selection"), *sì-bīn-zhǔ* 四賓主 ("four host-guest relations"), and the pedagogic use of the shout (*hē* 喝) and stick (*bàng* 棒).

### Tiyao

*No tiyao found in source (Buddhist canon text; no Sìkù tíyào apparatus applies).* The Taishō witness carries two prefaces: a Yuán-era preface by Línquán lǎorén Cónglún 林泉老人從倫, abbot of Bào'ēn Chán sì 報恩禪寺 in Dàdū 大都, and a second preface of comparable date, both framing the recovery and re-printing of a copy of the older Sòng recension in the late thirteenth / early fourteenth century. The Cónglún preface is signed 元貞二年歲次丁未 — "Yuánzhēn 2, cyclical year *dīngwèi*," an internally inconsistent date (Yuánzhēn 2 = 1296 / *bǐngshēn*; *dīngwèi* = 1307 / Dàdé 11), usually read as a scribal slip in the cyclical notation rather than an error in the reign-era.
