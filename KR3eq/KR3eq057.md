...
The hxwd `_000.txt` opens with main text immediately, without a separate prefatory frame. The work is contiguous with the [[KR3eq013]] *Duìshān yīhuà* corpus.
