...
His learning flourished under Rénzōng. Huáng Líxiàn 黄黎獻 wrote a *Lüèlì yǐnjué* 畧例隱訣, Wú Mì 吳秘 wrote *Tōng shén* 通神, Chéng Dàchāng 程大昌 wrote *Yì yuán* 易原 — all developing Mù's account; while Yè Chānglíng 葉昌齡 wrote *Tú yì* 圖義 to refute him, Sòng Xián wrote *WángLiú Yì biàn* 王劉易辨 to attack him, and Lǐ Gòu in turn wrote *Shāndìng Yìtú lùn* 刪定易圖論. By the time of Cài Yuándìng [Cài Jìtōng 蔡季通], Cài held that Mù's scheme did not match the readings transmitted by Kǒng Ānguó and Liú Xīn, and instead held that ten was the *Hétú* and nine the *Luòshū*. Master Zhū followed him and wrote *Yìxué qǐméng* on this basis. From then on, in the works of Hú Yīguì 胡一桂, Dǒng Kǎi 董楷, and Wú Chéng 吳澄 — all in the ZhūCài line — Mù's charts went almost entirely out of transmission.

The present text was issued by the *Tōngzhìtáng* press; Hé Zhuó 何焯 holds that it was extracted from the Daoist Canon. Examining the *Daoist Canon catalogue* now: it is in fact in *Dòngzhēn bù*, "*Líng tú lèi*" section, "Yún" 雲 character-bin — a piece of evidence that the *túshū* school descends from Daoist origins. We register and preserve it; this in turn is enough to broaden our information.
...
Liú Mù 劉牧 (1011–1064), of Péngchéng 彭城 (modern Xúzhōu, Jiāngsū), is the founding figure of the early Northern Sòng *Yìtú* 易圖 ("*Yì*-chart") tradition. His teaching descended from Chōng Fàng 种放 (a major Daoist-affiliated thinker of the Tàizōng court), who in turn received transmission from Chén Tuán 陳摶 — the same source from which Shào Yōng's 邵雍 *Xiāntiān* 先天 chart-tradition descends, by way of Mù Xiū 穆修 and Lǐ Zhīcái 李之才. Liú Mù and Shào Yōng are accordingly counted as the two co-founders of the Sòng *Yìtú* movement, with the doctrinal split that Liú assigns 9 to the *Hétú* and 10 to the *Luòshū*, while Cài Yuándìng + Zhū Xī later assigned the reverse and canonized that reverse for the YuánMíngQīng examination tradition.

The work as we have it survives because of its incorporation in the Daoist Canon (*Dàozàng*) — under what is now Dàozàng 159 (= Kanripo [[KR5a0160]]), with the appendix *Yílùn jiǔshì* under DZ 160 (= [[KR5a0161]]) — from which Hé Zhuó's *Tōngzhìtáng jīngjiě* extracted it for canonical-classics circulation in 1680; the WYG version is a refinement of the *Tōngzhìtáng* text. The Sìkù editors register the *Dàozàng* origin of the work as a small piece of evidence for the Daoist sources of the entire Sòng *túshū* tradition — a judgment that aligns with twentieth-century scholarship (esp. Isabelle Robinet and Liú Yǐng 劉影).

Liú Mù's other work, the eleven-juan *Xīn zhù Zhōuyì* prose commentary, is wholly lost; only fragments survive through citations in Chéng Dàchāng's 程大昌 *Yì yuán* 易原 and other later works. Several of his close contemporaries — Huáng Líxiàn, Wú Mì, Chéng Dàchāng — wrote works developing his chart-corpus; Yè Chānglíng, Sòng Xián, and Lǐ Gòu wrote works refuting it. The most consequential refutation came posthumously, from Cài Yuándìng's *Yìxué qǐméng* 易學啟蒙 (compiled with Zhū Xī, completed 1186), which inverted Liú's *Hétú*/*Luòshū* assignments and made the CàiZhū version the canonical one.
