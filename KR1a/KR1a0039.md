...
textid: KR1a0039
title: 趙氏易說
titlePinyin: Zhàoshì Yì shuō
titleEnglish: Master Zhào's Talks on the Yì
extent: 4 卷
notBefore: 1180
notAfter: 1186
dynasty: 宋
...
The work's *YìTàixuán* parallel — read at the *Yì tǒng lùn* — locates Zhào Shànyù in the *xiàngshù* end of the field, but a *xiàngshù* informed by classifying-and-collating impulses rather than by speculative cosmogenesis. The *jūnfù* / *chénzǐ* parallel between *Yì* and *Tài xuán* is one of the more theoretically substantive late-Sòng readings of Yáng Xióng's project.

The work's pedagogical intent is signaled by the Qín Yù 1186 reprint preface: the smaller-format reprint was meant for student use, and was widely read in the JiànkāngHúběi educational circuit in the late twelfth century before transmission failed in the YuánMíng period.
...
Zhào Shànyù's typological method is a quiet but real ancestor of the Qīng-period *Yì xíngshū lèi* 易象書類 ("classified-by-imagery") *Yì*-studies of Jiāo Xún and others. The *cross-hexagram* reading procedure is preserved in modern *Yì*-pedagogy as the standard technique for hexagram-cluster study (e.g. *TàiPǐ* 泰否, *SǔnYì* 損益, *JìjìWèijì* 既濟未濟 pairs).
