...
7. **Conflation history.** The conflation of ZhūChéng commentaries into a single book is not a Yǒnglè-era innovation; it begins with Dǒng Kǎi 董楷's late-Sòng *Zhōuyì zhuàn yì fù lù* [[KR1a0044]]. The Yǒnglè *dà quán* simply compounded the editorial damage.

The Wú Gé 1265 print, with juan-end "校正" mark by Lǐu Bīn 劉賓 of Fùyuán 敷原, is the textually clean archetype the Sìkù editors restore.
...
The present text is the print cut by Wú Gé of Jiǔjiāng in *Xiányán yǐchǒu* [1265]; the imperial inner storehouse used a Sòng cutting from which it was photographically copied. At the head is Gé's preface; at the end of each juan, the title-line "Lǐu Bīn 劉賓 of Fùyuán 敷原 collated." The text-format-and-line-arrangement, and the absence of Chéng's *Zhuàn* under the *Xiàng zhuàn* of the *Lǚ* 履 and *Guài* 夬 hexagrams — all match what Yánwǔ said.
...
- **Cài Yuándìng** for the *HétúLuòshū* numerology (*Yìxué qǐméng*'s 9 / 10 reversal of Liú Mù [[KR1a0011]]).
...
3. **Tokugawa-Japanese reception.** Itō Jinsai 伊藤仁齋 and Ogyū Sorai 荻生徂徠 each engaged the *Běnyì* substantively in their kogaku 古學 critique of SòngMíng *li-xué*.
