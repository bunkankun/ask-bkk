...
The *Yì* specifically: "*The* Yì *is the Sage's coming-into-action; therefore he uses it to ride-the-times. Times' transformations come without limit, and the* Yì*'s principle also goes-with-them without limit. Use it well — auspicious; use it ill — regret-or-trouble. The ancient sages' flowing-circulation-and-transformation, leading-the-people in usage, all are the marvel of using-the-* Yì. *YáoShùn's abdication, TāngWǔ's punitive expedition, Yī-[Yǐn]-Zhōu-[gōng]'s flourishing, KǒngMèng's hardship — in the world there are these times, in the* Yì *there are these principles, in the sages there are these uses.*"

The title *Yòng Yì* (Using-the-*Yì*) invokes Wáng Tōng 王通's (Suí *Wénzhōngzǐ* 文中子) signature formula "*the* Yì *is the sage's coming-into-action*" (*Yì, shèngrén zhī dòng yě* 易，聖人之動也).
