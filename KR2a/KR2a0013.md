...
The terminus *post quem* must be the late Northern Sòng (since the work depends on the Northern Sòng *jiān-běn* tradition). The terminus *ante quem* is the work's submission to the *Sìkù* in 1781. A late-Ming or early-Qing dating is most plausible on stylistic grounds; the date bracket given here (ca. 1100–1700) is therefore conservatively wide.
