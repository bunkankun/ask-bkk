...
The earliest of the so-called *sānjiā zhù* 三家注 (three classical commentaries) on the *Shǐjì* (KR2a0001), and the only annotated *Shǐjì* exemplar circulating in the Tang. Originally in 80 *juǎn*; the present 130-*juǎn* division reflects the Máo Jìn 毛晉 *Jígǔ-gé* 汲古閣 reissue, which split the commentary across the same juan-numbering as the *Shǐjì* main text.
