...
A late-Kāng-xī or early-Yōng-zhèng *fújī* compendium re-presenting the *Wǔ Liǔ pài* inner-alchemy doctrine in the planchette voice of the apotheosised Wǔ Shǒuyáng — i.e., a *posthumous* exposition by the master who had died in 1644. The *bǐshòu* (brush-receiver), *Dànxiū dìzǐ* = Zhào Zhíxìn (cf. [[趙執信]]), brings to the work a documented Hanlin connection and dates the planchette session within Zhào's lifetime (1662–1744) — most plausibly in the early Qiánlóng era (Zhào lived to 1744). The doctrinal content is a continuation of the *Wǔ Liǔ pài* curriculum and includes the standard *jīndān* cosmology mapped to the *Yì jīng* (the *qián / kūn / kǎn / lí* hexagram-correspondence to *jīng / qì / shén* applied to physiological alchemy).
