...
- **Rejects the upper/lower *Dào-Dé* division.** Sīmǎ argues that the *Lǎozǐ* should not be divided into two books (on the Way and on the Virtue); he presents the text as a single continuous philosophical discourse.
