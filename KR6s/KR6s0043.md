...
The work draws on the **Brahmajāla-sūtra** 梵網經 (T1484) — the standard canonical source for bodhisattva precepts in Chinese Buddhism — but renders the precepts in **mnemonic verse-form** for actual chant-recitation in ceremony. Each precept is paired with a karmic-consequence narrative (the mother-thinness for stealing, becoming a beast-body, etc.) — making the text simultaneously a **liturgical script** and a **karmic-pedagogical instructional resource** for new bodhisattva-precept recipients.
...
- CBETA: T85n2851
- Doctrinal source: **Brahmajāla-sūtra** 梵網經 (T1484)
