...
The final entries give the **detailed iconography** for several specific deities — *Maitreya*'s Sanskrit name, secret name (*Swift Vajra*, *Xùn-jí jīn-gāng* 迅疾金剛), seed-syllable, and three-equality-form (*lotus with water-jar above*) — providing usable practical references.
