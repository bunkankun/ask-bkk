...
A two-fascicle **Shingon ritual compendium** by **Shukaku Shinnō** 守覺親王 (1150–1202), the great imperial-prince-monk of Ninnaji. Where the bulk of late-Heian Shingon ritual literature documents the principal *bessen-hō* of the standard pantheon, the *Yì-zūn chāo* — "Compendium of the *Uncommon* Honored Ones" — is devoted specifically to the **secondary, infrequently-performed** rites. The work's own opening note explains: "*The Master's word: this honored-one method is paper-thin like a double layer (薄二重) — i.e. rarely-applicable; it differs from the common honored-one methods that are usually not performed. Hence: 'Uncommon Honored Ones.'*"
