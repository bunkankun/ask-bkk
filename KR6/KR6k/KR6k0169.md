...
titleEnglish: Glosses on the Preface of the Zīchí jì, with the Lecture on the Five Examples
extent: 1卷
notBefore: 1100
notAfter: 1140
indexYear: 1120
...
*Glosses on the Preface of the Zīchí jì, with the Lecture on the Five Examples*
by [[則安]] (Zéān, 述)
...
- [CBETA X0740](https://cbetaonline.dila.edu.tw/X0740)
- [則安 DILA](https://authority.dila.edu.tw/person/?fromInner=A000815)
- [Kanseki DB](http://kanji.zinbun.kyoto-u.ac.jp/kanseki?query=資持記序解并五例講義)
