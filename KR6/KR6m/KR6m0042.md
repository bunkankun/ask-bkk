...
X868 is one of relatively few *kēwén* treatments of the *Zhàolùn* tradition to have entered the *Xù zàngjīng* compilation. The Tiāntái-Chán cross-school joint authorship of the surviving recension (Zūnshì + Xiǎoyuè) is itself testimony to the *Zhàolùn*'s status as a pan-school foundational reference in Northern-Song Buddhist scholasticism.
