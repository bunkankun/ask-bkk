...
The *Cúnchéngtáng* and *Dǔsùtáng* studio-names trace from the *Lǐ jì*'s *Cún chéng* ("preserve sincerity") and *Lùn yǔ*'s *Dǔ xìn shàn xué* ("honest in conviction, fond of learning") — the latter recasting Wáng Yángmíng's *Sùxīn* into a Chéng-Zhū vocabulary. Zhāng's poetics align with [[王士禛]] Wáng Shìzhēn's *Shényùn* but stay decisively on the imperial-court side of the high-Kāngxī literary divide.
