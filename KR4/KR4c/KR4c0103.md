...
The collection's literary importance rests on three things: (a) Huáng's role as Wáng Shěnzhī's principal literary remonstrator — he is credited (per the *Sìkù* tiyao) with the moral instruction that kept Wáng Shěnzhī loyal in name to the Táng-Liáng court despite the de facto independence of Mǐn; (b) the collection's stele-and-inscription material on Mǐn-period Buddhism (the *Quánzhōu Kāiyuánsì*, *Fúzhōu Bàoēn dìngguāng tǎ*, *Fúzhōu Xuěfēng zhēnjué dàshī* steles) which is a major primary source for the institutional history of Fújiàn Chán; (c) Huáng's *Yǐngchuān Chén xiānshēng jí xù* (postface to a now-lost collection of Chén Póyǐn) which is the principal Mǐn-period statement on local literary culture.
