...
(1) **Provenance and survival.** The work was composed in hiding from war (Lántián valley) c. 1360–1370, with the self-preface signed *Hóngwǔ gēng-xū* (1370). It was preserved only in private family transmission, and not printed until 1538 — almost 170 years after its completion — by the Jiājìng prefectural-gazetteer editor Mǐn Wénzhèn. The published *juàn* are still in unfinished form (some passages give canonical text, others only headings; some written full-size, others as inserted glosses) — the unrefined state of a draft that was never finalized.
