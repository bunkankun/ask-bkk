...
textid: KR2m0013
title: 欽定大清會典則例
pinyinTitle: Qīndìng Dà Qīng Huìdiǎn Zélì
extent: 180 卷
notBefore: 1764
notAfter: 1764
dynasty: 清
...
The *Zhōu lǐ*, as a single dynasty's great codex, is in fact often summary in its statement of the offices. Material that survives elsewhere—the *Zuǒ zhuàn* on capital-city dimensions ("a great metropolis no larger than one-third the capital"), the *Yì Zhōushū* on great and small county dimensions—matches the system but is not in the *Zhōu lǐ*; the heir-apparent birth-rite recorded in the *Zuǒ zhuàn* (with *tài-láo* ceremony, *bǔ shì* prognostication, and *shìqī* nursing), more fully detailed in the *Lǐjì Nèizé*, is similarly absent from the *Zhōu lǐ*. So we know that the *Zhōu lǐ* gives the essentials, and the detailed enumerations were preserved separately, in archives that complemented the *Liù-diǎn*.
