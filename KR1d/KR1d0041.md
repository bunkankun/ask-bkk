...
textid: KR1d0041
title: 儀禮析疑
titlePinyin: Yílǐ xīyí
titleEnglish: Analyzing the Doubts in the Yílǐ
extent: 17 卷
notBefore: 1720
notAfter: 1749
dynasty: 清
...
As, *Shìguānlǐ "zībùguān, kuēxiàng"* (the *zī*-cloth cap with *kuēxiàng* hanging) — Zhèng Kāngchéng read *kuē* as *kuǐbiàn*'s *kuǐ*; Áo Jìgōng held: with one *zī*-cloth strip enclosing the cap as *kuēxiàng*; another with one object piercing it; the two complements further attaching the cord. Recent *Yílǐ* expositors mostly use his account. Bāo holds: already having *jiè* (hair-ornament) to bind the hair, no need to use *zī*-cloth to enclose; according to the classical text uses cyan-cord as *zī* — behind attaching to *kuēxiàng* and front tying at the two complements to bind under the chin. Not knowing Zhèng Kāngchéng read *kuē* as *kuǐ* — though character-changing — but separately notes "in the *xiàng* there is *huì*" — sub-commentary saying "two ends both make *huì*; separate cord piercing-the-*huì*-middle to tie it." The *Guǎngyùn* glosses *huì* as *kuēlèi*; the *Lèipiān* says *huì* — knot. Then Zhèng's this note can be largely relied upon: clear there is *kuēxiàng* with cloth as a knot, then attaches the cord. Áo Jìgōng's account still has un-clarified portions; Bāo then departs from Áo even further.
...
*Yǒusīchè* "*yòuzǔ*" two characters — apparently total-opening of sheep left-shoulder, left-back-leg downward; lower paragraph "*zuòzǔ*" then opens sheep-lung-and-other-things. Yet Bāo holds: the previous text has *yòu* and *zǔ*, this is interpolation; the result not matching with the lower step *zǔ* — all from not careful examination.
...
The Sìkù editors' detailed critique of Fāng's reading of the *Shìhūnlǐ nàzhēng xuánxūn shùbó* passage — including the cross-reference to Zhèng Xuán's *Zhōulǐ* note and the *Lǐjì Zájì* note for the technical meaning of *shùbó* (束帛) as ten *gè* (個) bundled into five *liǎng* (兩) two-roll units — is a model of late-Qiánlóng evidential cross-referencing. The case demonstrates how the Sìkù editors used Fāng's own *Sānlǐ* method against him on specific passages where he had not adequately followed it.
