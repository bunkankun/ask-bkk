...
The *Dúshū jì shù lüè* is the principal Qīng compilation of numbered-set knowledge — the genre that gathers items canonically known by their number (Three Kings, Five Emperors, Six Arts, Seven Sages, Eight Trigrams, Nine Provinces, Hundred Officials, and so on). The two predecessor works it explicitly extends are Wáng Yīnglín's 王應麟 Sòng-period *Xiǎoxué gānzhū* 小學紺珠 and Zhāng Jiǔshào's 張九韶 Yuán-period *Qúnshū shí tuò* 羣書拾唾; the *Dúshū jì shù lüè* adds the Sòng-Yuán-Míng materials missed by those.
