...
(c) **The *Héjì jú fāng* critique**: Liú's work is part of the broader Jīn-Yuán critique of the Sòng imperial-pharmacy formulary tradition (cf. [[KR3e0033]]). The critique would crystallize in Zhū Zhènhēng's *Júfāng fāhuī* of 1347; Liú is the immediate doctrinal forerunner.

(d) **The Zhāng Jièbīn vs. Liú Wánsù controversy**: a recurring polarization in late-imperial Chinese medicine between the cold-cooling (Liú-Héjiān) and warming-tonifying (Zhāng-Jǐngyuè) positions. The SKQS editors' balanced reading — recognizing both schools' legitimate clinical applicability under different climatic-and-constitutional conditions — is one of the more attractive features of mid-Qīng medical historiography.
...
- [Kanseki DB](http://kanji.zinbun.kyoto-u.ac.jp/kanseki?query=素問玄機原病式)
