...
## Links
- [Wikidata Q11066907](https://www.wikidata.org/wiki/Q11066907) (仙授理傷續斷秘方).
- Wikipedia (zh): 仙授理傷續斷秘方.
- Online text: ctext.org (multiple recensions) and 中華醫典 hxwd.
- [仙授理傷續斷秘方 jicheng.tw](https://jicheng.tw/tcm/book/仙授理傷續斷秘方/index.html)
- [Kanseki DB](http://kanji.zinbun.kyoto-u.ac.jp/kanseki?query=仙授理傷續斷秘方)
