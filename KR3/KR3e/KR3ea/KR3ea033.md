...
The *Ika senjimon* is a short medical anthology in the form of a thousand-character primer in twenty-one rhyme-categories, composed by the Kamakura-period Japanese court physician **Korēmune no Tokitoshi** 惟宗時俊 (catalog meta gives 唯宗時俊, with 唯 an OCR variant of 惟). It draws on the *Sùwèn*, *Língshū*, *Nánjīng*, *Shānghán lùn*, *Jīnguì*, the *Qiānjīn fāng*, and other foundational classics, condensing core medical doctrine into rhymed mnemonic verses on the model of [[周興嗣]] Zhōu Xīngsì's *Qiānzì wén* (the canonical Liú-Cháo primer in a thousand non-repeating characters). The work is dated by Japanese reference works to *Kōan* 弘安 10 / 1287 at the earliest, and a complete fair copy is conventionally placed around *Kagen* 1 / 1303–1304.
