...
The work's significance is twofold: it provides important Eastern-Jìn witness to the *zhìguài* corpus before its Liú-Sòng codification, and it preserves several narratives — particularly the *Lóngquán* sword-omen — in early form. Lǐ Jiànguó treats it as a key bridge-text between Gān Bǎo's *Sōushén jì* and Liú Yìqìng's *Yōumíng lù*.
