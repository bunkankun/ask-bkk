...
Textual transmission. The 10-juan surviving core is transmitted through the Sòng-Yuán-Míng tradition; the *Yuán Dàdé* (1305) recension paired with *Bái hǔ tōng* is the basis of all subsequent printings. The lost juan are recovered in *jí yì* in modern editions, most fully in the work of Wáng Lìqì 王利器, *Fēng sú tōng yì jiào zhù* 風俗通義校注 (Zhōnghuá shūjú, 1981; rev. 2010). The SKQS recension is from the same Sòng-Yuán transmission; the kanripo source file is the SBCK printing of the Yuán *Dàdé* recension.
