...
The work's significance is twofold. (i) **Diagram-philological**: it preserves a non-trivially distinct version of the fourteen Chén-Tuán → Mù Xiū → Shào Yōng pre-Heaven diagrams as Zhāng Xíngchéng recovered them in Sìchuān, separately from the version that descends through Shào Bótāo 邵伯溫 and the *Huángjí jīngshì shū* proper. (ii) **Doctrinal**: it canonizes Shào Yōng's *jiāotài* and *jìjì* diagrams as the apex of the system and the *guàqì* doctrine as their underlying mechanism — a particular interpretation that subsequent Sòng-Yuán-Míng *Huángjí*-related literature would either adopt (Zhāng Lǐ 張理, Bào Yúnlóng 鮑雲龍 etc.) or refute (Yuán Shū, Xuē Jìxuān).
