...
The Zhāng Jiǔchéng 張九成 *Zhōng yōng jiě* attack — fifty-two items, half the *Zá xué biàn* — became the foundational document for the Sòng-Yuán-Míng *Lǐxué* mainstream's diagnostic against the *xīnxué*-tinged *Zhōng yōng* reading. Modern scholarship (e.g. Yú Yīngshí) has revisited some of Zhū's specific charges; in many cases Zhū's polemical reading of his targets is sharper than the targets' own text strictly warrants.
