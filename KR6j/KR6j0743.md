...
A one-fascicle (1卷) **astrological-divinatory manual** for examining a person's fate (*kànmìng* 看命) by a finger-counting palm-method (*yīzhǎng* 一掌, the "single palm"); pseudepigraphically attributed to the Tang astronomer-monk **Yīxíng** 一行 [[一行]] (683–727). Preserved as **X59 no. 1043** in the *Xùzàngjīng*.
