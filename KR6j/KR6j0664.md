...
*Oral Transmissions of the Wondrous-Seal Notes on the MahāvairocanaSūtra Commentary* (Jp. *Dainichi-kyō sho myōinshō kuden*)
by [[宥範]] (Yūhan, 撰)
...
The *Kǒuchuán* is the formal **oral-tradition record** corresponding to the written *Miàoyìn chāo*. In the Heian-and-Kamakura Shingon scholastic system, the *written commentary* and the *oral transmission* form complementary halves of the master-disciple curriculum: the written work supplies the systematic doctrinal exposition, while the oral transmission preserves the master's *secret* (奧義) insights into difficult passages, the *secret-seal* (祕印) and *secret-mudrā* (祕印) iconographies, the *secret-mantra* (祕咒) recitations, and the *guarded* (祕傳) ritual practices. The *Kǒuchuán* presents these in the original master-disciple *question-and-answer* (問答) format, preserving the spontaneous dynamism of the oral-instruction context.
