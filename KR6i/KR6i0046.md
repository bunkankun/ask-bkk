...
The *Kēwén* is the structural companion to [[KR6i0045]], which itself survives only in fascicles 2 and 4. The *kēwén* similarly begins with a lacuna marker (【上闕】), suggesting that the top of the outline — covering the opening of the commentary — was already lost when the text was copied into the *Sòngzàng yízhēn*. The surviving outline covers the exegesis of the formula "如是我聞" ("Thus I have heard"), with detailed sub-branching typical of Tang Yogācāra commentary practice. The pattern of interdigitated lacunae (【闕】 markers appearing mid-tree at several points) indicates the source manuscript suffered extensive damage before the *Sòngzàng yízhēn* copy was made. No author is identified in the surviving text; the outline presumably was produced either by Quánmíng himself as a structural key to his own commentary, or by a student in his circle. Since the parent commentary ([[KR6i0045]]) is attributed to Quánmíng ([[詮明]]), this outline is conventionally treated as part of the same textual unit.
...
- CBETA online: <https://cbetaonline.dila.edu.tw/zh/S0047>
