...
The Sìkù entry on the *Báishí dàorén shījí* (preserved in the *Sìkù tíyào*, not in the local file here) is the standard early-modern bibliographic statement of the work; the WYG recension treats *shī*, *cí*, *Shīshuō*, *Xù shūpǔ*, and *Gēqǔ* as separate-but-bound items. The textual line of the *Gēqǔ* with its precious music notation goes through the late-Yuán Táo Zōngyí 陶宗儀 manuscript copy and the Qīng *jǐngSòng* reprint of Lù Zhōnghuī 陸鍾輝 (1743), the first to make Jiāng Kuí's *cí*-music broadly known. The SBCK base used here is one of these *jǐngSòng* lines.
