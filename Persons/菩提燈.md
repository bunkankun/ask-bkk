...
The *Zhàn-chá* is itself a problematic text in the Suí-Táng catalogues: it was suspected of apocryphal origin and was not initially included in the standard Suí-Táng inventories, only being formally canonised during the Táng. Modern scholarship (Whalen Lai; Funayama Tōru) treats the text as a likely *sino-apocryphon* of late-sixth-century date, with the "Bodhidīpa" attribution either fictional or referring to a translator known only by this single text. The DILA authority record A001360 preserves both spellings (菩提燈 / 菩提登) without disambiguation.
