...
The KR source `KR3ed061_000.txt` begins directly with body text (item 1: *Hǔpò dìngtòng wán* 琥珀定痛丸) without a separate preface. The work circulates in late-Republican and post-1949 reprints, often appended to the *Dīng Gānrén yīàn* 丁甘仁醫案 (Dīng's case-records).
