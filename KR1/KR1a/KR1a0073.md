...
The work's two surviving components — *Yì yuán ào yì* (1 juan) + *Zhōuyì yuán zhǐ* (6 or 8 juan) — combined under the title *Yì tǐ yòng*. The methodological framework: hexagram-*tǐ* (substance) → hexagram-*yòng* (function), with the *ào yì* providing the foundational-cosmological *Hétú-Luòshū* / *Sāntiān* structures and the *yuán zhǐ* applying these to the canonical text running gloss.
...
- [Kanseki DB](http://kanji.zinbun.kyoto-u.ac.jp/kanseki?query=易源奧義)
