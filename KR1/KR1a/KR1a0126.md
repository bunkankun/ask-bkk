...
textid: KR1a0126
title: 仲氏易
titlePinyin: Zhòngshì Yì
titleEnglish: The Yì of the Second-Eldest [Brother]
extent: 30 卷
notBefore: 1685
notAfter: 1700
indexYear: 1692
...
Máo's broader scholarly polemic — opposing the Sòng *Lǐxué* synthesis on multiple fronts, including the chart-tradition (*Tài jí tú shuō yí yì*, *Hé tú Luò shū yuán shùn biàn*) and the *Yì*-method itself (*Tuī yì shǐ mò*, *Chūnqiū zhàn shì shū*) — gives the *Zhòngshì Yì* a clear position within the broader early-Qīng *kǎozhèng* turn. The attribution to his elder brother is rhetorical: the *Sìkù* editors' frank diagnosis that "in fact the explanation is precisely Qílíng's own" is the standard view.
...
- [Kanseki DB](http://kanji.zinbun.kyoto-u.ac.jp/kanseki?query=仲氏易)
