...
title: 易類
titlePinyin: Yì lèi
titleEnglish: Classics — Book of Changes
parentDivision: KR1
created: 2026-05-05
updated: 2026-05-16
reviewed: 2026-05-16
...
The chronological span of the collected works runs from the Hàn weft texts ([[KR1a0163]]–[[KR1a0170]], attributed to Zhèng Xuán 鄭玄 but transmitted in fragments) through the great Wèi reading of Wáng Bì 王弼 ([[KR1a0006]], ca. 240–249), the Táng synthesis of Kǒng Yǐngdá and Lǐ Dǐngzuò, the Sòng-dynasty explosion of philosophical commentary culminating in the Chéng-Zhū tradition, the Yuán and early Míng *zhézhōng* 折衷 syntheses, and the Qīng evidential turn that worked to recover the lost Hàn 易. By count, Sòng (≈ 57 works) and Qīng (≈ 48) dominate, with smaller but pivotal Hàn, Wèi, Táng, Yuán, and Míng layers. The division is thus a near-complete cross-section of the longest-running exegetical tradition in the Chinese classical corpus.

## Important texts and text clusters

**Canonical text and Hàn / pre-Wèi layer.**
- *Zhōuyì* 周易 [[KR1a0001]] — the canonical text itself, the starting point for every commentary in the division.
- *Zǐxià Yìzhuàn* 子夏易傳 [[KR1a0002]] — pseudepigraphically attributed to Bǔ Shāng 卜商 (子夏); the received recension is post-Táng and is the oldest *Yìzhuàn* preserved in transmission.
- *Zhōuyì Zhèng Kāngchéng zhù* 周易鄭康成註 [[KR1a0003]] and the Qīng *Zēngbǔ Zhèng shì Zhōuyì* 增補鄭氏周易 [[KR1a0004]] — Wáng Yīnglín's 王應麟 Sòng-era reconstruction of Zhèng Xuán's 鄭玄 lost commentary and Huì Dòng's 惠棟 Qīng supplement; the principal channel by which Hàn 易 entered the Sìkù.
...
- *Zhōuyì Chéng-Zhū zhuànyì zhézhōng* 周易程朱傳義折衷 [[KR1a0074]], *Zhōuyì běnyì tōngshì* 周易本義通釋 [[KR1a0078]], *Yì zuǎn yán* 易纂言 [[KR1a0071]] — Zhào Cǎi 趙采, Hú Bǐngwén 胡炳文, and Wú Chéng 吳澄 systematize the Chéng-Zhū settlement, fixing the textbook *Yì* of the late imperial examination system.
...
**Qīng — evidential recovery and imperial codification.**
- *Yù zuàn Zhōuyì zhé zhōng* 御纂周易折中 [[KR1a0117]] — Lǐ Guāngdì's 李光地 1715 imperially-commissioned compendium, the Qīng counterpart to Hú Guǎng's *Dàquán*.
- *Yù zuàn Zhōuyì shù yì* 御纂周易述義 [[KR1a0118]] — Fù Héng's 傅恒 1755 follow-on compendium.
- *Zhōuyì bài shū* 周易稗疏 [[KR1a0120]] — Wáng Fūzhī's 王夫之 austere line-by-line reading, philosophically the most independent Qīng *Yì*.
- *Yì xué xiàng shù lùn* 易學象數論 [[KR1a0123]], *Zhōuyì xiàng cí* 周易象辭 [[KR1a0124]] — Huáng Zōngxī 黃宗羲 and Huáng Zōngyán's 黃宗炎 dismantling of Sòng diagram lore.
- *Yì tú míng biàn* 易圖明辨 [[KR1a0138]] — Hú Wèi's 胡渭 systematic demonstration that the Sòng-era 河圖 *Hétú* and 洛書 *Luòshū* diagrams are post-Hàn fabrications; the philological hinge of the entire Qīng *kǎozhèng* attack on Sòng *Yì*.
- *Yì Hàn xué* 易漢學 [[KR1a0156]], *Zhōuyì shù* 周易述* [[KR1a0155]], *Yì lì* 易例 [[KR1a0157]] — Huì Dòng's 惠棟 reconstruction of the Hàn *Yì*, the high-water mark of evidential learning in the division.
...
- [[程頤]] (Chéng Yí) — author of [[KR1a0016]], the dominant 義理 commentary of the millennium.
- [[朱震]] (Zhū Zhèn) — Southern Sòng partisan of Hàn 象數 inside a Sòng frame [[KR1a0024]].
...
- [[胡渭]] (Hú Wèi) — author of the decisive demolition of the *Hétú*-*Luòshū* tradition [[KR1a0138]].
- [[李光地]] (Lǐ Guāngdì), [[傅恒]] (Fù Héng) — directors of the two great Qīng imperial compendia [[KR1a0117]] and [[KR1a0118]].
- [[毛奇齡]] (Máo Qílíng) — early-Qīng polymath, author of multiple iconoclastic *Yì* studies [[KR1a0126]] [[KR1a0127]] [[KR1a0128]] [[KR1a0129]].
- [[惠棟]] (Huì Dòng) — supreme reconstructor of the Hàn *Yì* and editor of [[KR1a0004]]; author of [[KR1a0155]] [[KR1a0156]] [[KR1a0157]].
- [[王應麟]] (Wáng Yīnglín) — Sòng polymath whose reconstructive method behind [[KR1a0003]] founded the project Huì Dòng later perfected.
...
- **Hàn 易 recovery (Qīng *kǎozhèng*).** The reconstructive project of Wáng Yīnglín, Máo Qílíng, and above all Huì Dòng, aimed at recovering the lost commentaries of Zhèng Xuán, Xún Shuǎng, Yú Fān, and the 緯 corpus from quotations preserved in [[KR1a0008]] and elsewhere. Wilkinson notes the broader Qīng pattern: by the eighteenth century the accumulated commentary on the Thirteen Classics ran to more than a hundred times the length of the originals (Wilkinson §28.7.4).

- **Divination vs. philosophy.** Zhū Xī's polemic that the *Yì* was originally a divination manual (and only secondarily a moral text) reframed late-imperial reading practice and is the explicit hinge of [[KR1a0031]]; later commentators repeatedly take a position on his claim.

- **Imperial codification.** Three state compendia structure the late-imperial reception: the early-Míng *Zhōuyì zhuànyì dàquán* [[KR1a0091]], the high-Qīng *Zhé zhōng* [[KR1a0117]] under Lǐ Guāngdì, and the *Shù yì* [[KR1a0118]] under Fù Héng. These set the curriculum and define the boundary between orthodox and unorthodox readings.

## Timeline

- **ca. 9th–8th c. BCE** — *Zhōuyì* 周易 [[KR1a0001]] core (trigrams, hexagrams, line statements) takes shape.
- **3rd c. BCE** — Ten Wings (*Yìzhuàn* 易傳) appended.
...
- **1650–1692** — Wáng Fūzhī *Zhōuyì bài shū* [[KR1a0120]].
- **1655–1690** — Huáng Zōngxī *Yì xué xiàng shù lùn* [[KR1a0123]]; Huáng Zōngyán *Zhōuyì xiàng cí* [[KR1a0124]] — the Qīng anti-diagram critique opens.
- **1700–1706** — Hú Wèi *Yì tú míng biàn* [[KR1a0138]] — the diagrams definitively dethroned.
- **1713–1715** — Lǐ Guāngdì *Yù zuàn Zhōuyì zhé zhōng* [[KR1a0117]] — Qīng imperial compendium.
- **1730–1758** — Huì Dòng *Yì Hàn xué* [[KR1a0156]], *Zhōuyì shù* [[KR1a0155]], *Yì lì* [[KR1a0157]], and *Zēngbǔ Zhèng shì Zhōuyì* [[KR1a0004]] — high-Qīng evidential recovery of Hàn *Yì*.
- **1755** — Fù Héng *Yù zuàn Zhōuyì shù yì* [[KR1a0118]].
- **1765** — Zhái Jūnlián *Zhōuyì zhāng jù zhèng yì* [[KR1a0162]] — closes the Sìkù-period sequence.
