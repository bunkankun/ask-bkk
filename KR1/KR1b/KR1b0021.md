...
The transmission history is straightforward: composed and prefaced 1207, lost during the Yuán-Míng transition, recovered from the *Yǒnglè dàdiàn* by the Sìkù in 1781. Title variants — *Tǒng lùn* 統論 (Sòngshǐ), *Tǒng jì* 統紀 (Wényuángé shūmù), *Tǒng yī* 統一 (Yǒnglè dàdiàn / Sìkù) — all preserve the same substantive thesis.
