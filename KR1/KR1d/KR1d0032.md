...
title: 儀禮圖
titlePinyin: Yílǐ tú
titleEnglish: Diagrams of the Yílǐ
extent: 17 卷
notBefore: 1220
notAfter: 1228
indexYear: 1224
...
What appears in *gōngmiào door* is only seven diagrams — quite skimpy. Furthermore the distance-and-extent-and-broadness-and-narrowness lacks proportional measurement at all. As, for instance, the *xù*-outside two *jiā* (Liú Xī's *Shìmíng* says "in the hall's two heads, hence called *jiā*") — the diagram lists them parallel with the *fángshì*; the *Gōngshídàfūlǐ* "*zǎi*-east-*jiā*-north-west-facing" sub-commentary saying "position is in the *běitáng*'s south"; *Tèshēng kuìshílǐ* "*dòubiānxíng* in the *east-táng*" note saying "*east-táng* is the *fáng*'s east, equivalent to *jiā*'s north" — all become foggy and lose their place. Door and east-and-west *shú* are on the same foundation; the diagram divides them into east-corner and west-corner — then *Shìyúlǐ* "*bǐzǔ* at *xīshú*'s west" has no place; and *Shìguānlǐ* "the prefect bears the *east shú*" similar — not in their place. Such examples lack systematic clarity.
