...
The corpus is among the most heavily annotated of any pre-modern Chinese imperial *wénjí* — the front matter alone contains the editorial memorial (with imperial response), the *fán-lì*, and the *zǒng-mù*, supplying a near-complete record of the editorial process for a Qīng-imperial *bié-jí*.
